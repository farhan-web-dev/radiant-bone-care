...
const degrees = [
  { name: "MBBS (DOW)", label: "Bachelor of Medicine & Surgery" },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed">
              Dr. Abid Ali Khan is an **Assistant Professor** and PMDC-registered **Consultant
              Orthopaedic &amp; Trauma Surgeon**. With deep clinical expertise in complex fractures,
              bone injuries, joint pain, limb reconstructive surgery, and trauma care, he blends
              international medical standards with compassionate rehabilitation to help patients
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {degrees.map((deg, i) => (
                  ...
                  >
                    <span className="text-xs font-bold text-primary font-sans leading-tight">
                      {deg.name}
                    </span>
